...
export default function Overview() {
  ...
  return (
    <DashboardLayout title="Manufacturing Overview" breadcrumb="Manufacturing / Overview">
      ...
      <div className="mt-6">
        <p className="text-sm font-semibold text-ink mb-4">Live Grafana Dashboards</p>
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
          <GrafanaPanel
            title={grafanaDashboards.kpi.title}
            description={grafanaDashboards.kpi.description}
            src={grafanaDashboards.kpi.url}
            height={340}
          />
          <GrafanaPanel
            title={grafanaDashboards.machineStatus.title}
            description={grafanaDashboards.machineStatus.description}
            src={grafanaDashboards.machineStatus.url}
            height={340}
          />
        </div>
      </div>
