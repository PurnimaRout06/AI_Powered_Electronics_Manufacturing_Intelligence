...
export default function Maintenance() {
  ...
  return (
    <DashboardLayout title="Maintenance" breadcrumb="Manufacturing / Maintenance">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mt-4">
        <GrafanaPanel
          title={grafanaDashboards.downtime90d.title}
          description={grafanaDashboards.downtime90d.description}
          src={grafanaDashboards.downtime90d.url}
          height={380}
        />
        <GrafanaPanel
          title={grafanaDashboards.recentMaintenanceLog.title}
          description={grafanaDashboards.recentMaintenanceLog.description}
          src={grafanaDashboards.recentMaintenanceLog.url}
          height={380}
        />
      </div>
