  ...
  return (
    ...
    >
      ...
      <div className="border-t border-white/10 px-3 py-4 space-y-1">
        <NavItem item={{ to: '/preferences', label: 'Preferences', icon: Settings }} collapsed={collapsed} />
        ...
        <div className={clsx('flex items-center gap-2.5 px-3 pt-3 mt-2 border-t border-white/10', collapsed && 'justify-center px-0')}>
          ...
          {!collapsed && (
            <button onClick={handleLogout} title="Sign out" className="text-slate-400 hover:text-white transition-colors">
              <LogOut size={15} />
            </button>
          )}
        </div>
